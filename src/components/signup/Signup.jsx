...
function Signup() {
    ...
    const handleSubmit = async (e)=>{
      ...
      try {
        const response = await axios.post("http://localhost:3001/varification/register", {
            name,
            phoneNumber,
            email,
            password
        ...
        console.error(error.response?.data?.message || "Registration failed. Email may already exist.");
    }
    }
  return (
